...
import { AccessRequest, RequestStatus, UrgencyLevel } from '../shared/interfaces/user.interface';
    ...
    <div class="space-y-6">
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-secondary-900">{{ metrics().totalRequests | number }}</p>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-secondary-900">{{ metrics().pendingApprovals }}</p>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-secondary-900">{{ metrics().activeUsers | number }}</p>
              <p class="text-xs text-success-600 flex items-center mt-1">
                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                </svg>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-secondary-900">{{ metrics().riskScore }}</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 card">
          <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-semibold text-secondary-900">Recent Access Requests</h2>
            <button class="text-sm text-primary-600 hover:text-primary-700">View All</button>
          </div>
          
          <div class="space-y-4">
            <div *ngFor="let request of recentRequests(); trackBy: trackByRequestId" 
              ...
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <p class="font-medium text-secondary-900">{{ request.requesterName }}</p>
                  <p class="text-sm text-secondary-600">{{ request.requestedRoles[0]?.name || 'Access Request' }}</p>
                  <p class="text-xs text-secondary-500">{{ request.submittedAt | date:'short' }}</p>
                </div>
              </div>
        ...
        <!-- Risk Assessment -->
        <div class="card">
          <h2 class="text-lg font-semibold text-secondary-900 mb-6">Risk Assessment</h2>
          
          <div class="space-y-4">
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-sm text-secondary-600">Critical Risk</span>
                <span class="text-sm font-medium text-danger-600">3 requests</span>
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div class="bg-danger-600 h-2 rounded-full" style="width: 15%"></div>
              </div>
            </div>
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-warning-600">8 requests</span>
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div class="bg-warning-600 h-2 rounded-full" style="width: 40%"></div>
              </div>
            </div>
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-primary-600">12 requests</span>
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-success-600">25 requests</span>
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div class="bg-success-600 h-2 rounded-full" style="width: 80%"></div>
              </div>
            </div>
          </div>
          ...
          <div class="mt-6 p-4 bg-warning-50 border border-warning-200 rounded-lg">
            <div class="flex items-center">
              <svg class="w-5 h-5 text-warning-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
              </svg>
              <div>
                <p class="text-sm font-medium text-warning-800">Action Required</p>
                <p class="text-xs text-warning-700">3 high-risk requests need immediate review</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button class="flex items-center p-4 border border-secondary-200 rounded-lg hover:bg-secondary-50 text-left">
            <svg class="w-8 h-8 text-primary-600 mr-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button class="flex items-center p-4 border border-secondary-200 rounded-lg hover:bg-secondary-50 text-left">
            <svg class="w-8 h-8 text-warning-600 mr-4" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
            </svg>
            <div>
          ...
          <button class="flex items-center p-4 border border-secondary-200 rounded-lg hover:bg-secondary-50 text-left">
            <svg class="w-8 h-8 text-success-600 mr-4" fill="currentColor" viewBox="0 0 20 20">
