...
import { ProvisioningWorkflow, WorkflowType, WorkflowStatus, SecurityClearance, DataClassification } from '../../shared/interfaces/user-management.interface';
  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-secondary-900">User Provisioning</h1>
          <p class="text-secondary-600">Create new user accounts with automated workflow processing</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="metric-card">
          <div class="text-center">
            <p class="text-2xl font-bold text-primary-600">{{ provisioningWorkflows().length }}</p>
            <p class="text-sm text-secondary-600">Active Workflows</p>
          </div>
        </div>
        <div class="metric-card">
          <div class="text-center">
            <p class="text-2xl font-bold text-warning-600">{{ getPendingWorkflows() }}</p>
      ...
      <!-- New User Form -->
      <div class="card">
        <h2 class="text-lg font-semibold text-secondary-900 mb-6">Create New User</h2>
        
        <form (ngSubmit)="submitProvisioningRequest()" class="space-y-6">
          <!-- Personal Information -->
          <div>
            <h3 class="text-md font-medium text-secondary-900 mb-4">Personal Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Employee ID *</label>
                <input 
                  type="text"
          ...
          <div>
            <h3 class="text-md font-medium text-secondary-900 mb-4">Employment Information</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Organization Unit</label>
                <input 
                  type="text"
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Manager</label>
                <input 
                  type="text"
          ...
          <div>
            <h3 class="text-md font-medium text-secondary-900 mb-4">Security Configuration</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Security Clearance</label>
                <select 
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Data Classifications</label>
                <div class="space-y-2">
                  <label class="flex items-center">
                    <input type="checkbox" checked disabled class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Internal (Default)</span>
                  </label>
                  <label class="flex items-center">
                    <input type="checkbox" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Confidential</span>
                  </label>
                  <label class="flex items-center">
                    <input type="checkbox" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Restricted</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <!-- Access Requirements -->
          <div>
            <h3 class="text-md font-medium text-secondary-900 mb-4">Initial Access Requirements</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Standard Role Templates</label>
                <div class="space-y-2">
                  <label class="flex items-center">
                    <input type="checkbox" checked class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Employee (Standard)</span>
                  </label>
                  <label class="flex items-center">
                    <input type="checkbox" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">VPN Access</span>
                  </label>
                  <label class="flex items-center">
                    <input type="checkbox" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Office 365</span>
                  </label>
                  <label class="flex items-center">
                    <input type="checkbox" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                    <span class="ml-2 text-sm text-secondary-700">Development Tools</span>
                  </label>
                </div>
              </div>
          ...
          <div class="p-4 bg-secondary-50 border border-secondary-200 rounded-lg">
            <h3 class="text-md font-medium text-secondary-900 mb-3">Automated Workflow</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="flex items-center">
                  <input type="checkbox" [(ngModel)]="workflowConfig.requireApproval" name="requireApproval" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                  <span class="ml-2 text-sm text-secondary-700">Require Manager Approval</span>
                </label>
              </div>
              <div>
                <label class="flex items-center">
                  <input type="checkbox" [(ngModel)]="workflowConfig.notifyHR" name="notifyHR" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                  <span class="ml-2 text-sm text-secondary-700">Notify HR on Completion</span>
                </label>
              </div>
              <div>
                <label class="flex items-center">
                  <input type="checkbox" [(ngModel)]="workflowConfig.scheduleReview" name="scheduleReview" class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                  <span class="ml-2 text-sm text-secondary-700">Schedule 90-day Access Review</span>
                </label>
              </div>
              <div>
                <label class="flex items-center">
                  <input type="checkbox" [(ngModel)]="workflowConfig.enableAuditLogging" name="enableAuditLogging" checked disabled class="rounded border-secondary-300 text-primary-600 focus:ring-primary-500">
                  <span class="ml-2 text-sm text-secondary-700">Enable Audit Logging (Required)</span>
                </label>
              </div>
            </div>
          </div>
      ...
      <div class="card">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-lg font-semibold text-secondary-900">Recent Provisioning Workflows</h2>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-secondary-200">
            ...
            <tbody class="bg-white divide-y divide-secondary-200">
              <tr *ngFor="let workflow of provisioningWorkflows(); trackBy: trackByWorkflowId" class="hover:bg-secondary-50">
                <td class="table-cell">
                ...
                <td class="table-cell">
                  <span class="text-sm">{{ workflow.createdAt | date:'MMM d, y' }}</span>
                </td>
                <td class="table-cell">
...
export class UserProvisioningComponent implements OnInit {
  ...
  private loadProvisioningWorkflows() {
    this.userManagementService.getWorkflowsByType(WorkflowType.UserProvisioning).subscribe(workflows => {
  ...
  approveWorkflow(workflowId: string) {
    this.userManagementService.approveWorkflow(workflowId, 'current-user', 'Approved for provisioning').subscribe(() => {
      this.loadProvisioningWorkflows();
    });
  }
  ...
  getPendingWorkflows(): number {
    return this.provisioningWorkflows().filter(w => w.status === WorkflowStatus.Pending).length;
  }

  getCompletedWorkflows(): number {
    return this.provisioningWorkflows().filter(w => w.status === WorkflowStatus.Completed).length;
  }
