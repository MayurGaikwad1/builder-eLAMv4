      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-secondary-600">
            Comprehensive user provisioning, deprovisioning, and lifecycle
            management
          </p>
        </div>
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-danger-600"
                  >{{ analytics().riskDistribution.critical }} users</span
                >
              </div>
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-warning-600"
                  >{{ analytics().riskDistribution.high }} users</span
                >
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-primary-600"
                  >{{ analytics().riskDistribution.medium }} users</span
                >
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-success-600"
                  >{{ analytics().riskDistribution.low }} users</span
                >
              </div>
              <div class="w-full bg-secondary-200 rounded-full h-2">
                <div
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center space-x-3">
                <div
                  [class]="getIntegrationStatusClass(integration.status)"
                ...
                <div>
                  ...
                  <p class="text-xs text-secondary-500">
                    Last sync: {{ integration.lastSync | date: "short" }}
                  </p>
                </div>
              </div>
              <div class="text-right">
                <p
                  ...
                  [class]="getHealthScoreClass(integration.healthScore)"
                >
          ...
          <button
            class="w-full mt-4 text-center text-sm text-primary-600 hover:text-primary-700 font-medium"
          >
            Manage Integrations
          </button>
        </div>
      ...
      <div class="card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button
            ...
            class="flex items-center p-4 border border-secondary-200 rounded-lg hover:bg-secondary-50 text-left group"
          >
            <svg
          ...
          <button
            routerLink="/users/deprovisioning"
            class="flex items-center p-4 border border-secondary-200 rounded-lg hover:bg-secondary-50 text-left group"
          >
            <svg
...
export class UserManagementComponent implements OnInit {
  ...
  getComplianceScore(): number {
    ...
    const total =
      analytics.complianceMetrics.compliantUsers +
      analytics.complianceMetrics.nonCompliantUsers;
    return total > 0
      ? Math.round((analytics.complianceMetrics.compliantUsers / total) * 100)
      : 0;
  }
  ...
  getRiskPercentage(riskLevel: "low" | "medium" | "high" | "critical"): number {
    const analytics = this.analytics();
    if (!analytics || !analytics.riskDistribution || analytics.totalUsers === 0)
      return 0;
