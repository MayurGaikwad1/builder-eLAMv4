  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <div>
          <h1 class="text-2xl font-semibold text-secondary-900">Access Reviews</h1>
          <p class="text-secondary-600 mt-1">Manage periodic access certifications and user access reviews</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-secondary-600">Active Reviews</p>
              <p class="text-2xl font-semibold text-secondary-900 mt-2">{{ getActiveReviewsCount() }}</p>
            </div>
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-secondary-600">{{ reviews().length }} total reviews</span>
            </div>
          </div>
        </div>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-secondary-600">Pending Items</p>
              <p class="text-2xl font-semibold text-warning-600 mt-2">{{ getTotalPendingItems() }}</p>
            </div>
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-secondary-600">{{ getTotalCompletedItems() }} completed</span>
            </div>
          </div>
        </div>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-secondary-600">Overdue Reviews</p>
              <p class="text-2xl font-semibold text-danger-600 mt-2">{{ getOverdueReviewsCount() }}</p>
            </div>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-secondary-600">Flagged Items</p>
              <p class="text-2xl font-semibold text-purple-600 mt-2">{{ getTotalFlaggedItems() }}</p>
            </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex space-x-3">
            ...
            >
              ...
              <option value="orphaned_account_review">Orphaned Account Review</option>
              <option value="privileged_access_review">Privileged Access Review</option>
            </select>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        >
          <div class="flex items-start justify-between mb-4">
            <div class="flex-1">
              <h4 class="text-lg font-medium text-secondary-900 mb-2">{{ review.name }}</h4>
              <p class="text-sm text-secondary-600 line-clamp-2">{{ review.description }}</p>
            </div>
          ...
          <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-secondary-700">{{ getReviewTypeLabel(review.reviewType) }}</span>
            </div>
          ...
          <div class="mb-4">
            <div class="flex items-center justify-between text-sm mb-2">
              ...
              <span class="font-medium text-secondary-900">{{ getReviewProgress(review) }}%</span>
            </div>
          ...
          <div class="grid grid-cols-3 gap-3 mb-4">
            <div class="text-center">
              <div class="text-lg font-semibold text-secondary-900">{{ review.totalItems }}</div>
              <div class="text-xs text-secondary-500">Total Items</div>
            </div>
            <div class="text-center">
              <div class="text-lg font-semibold text-success-600">{{ review.approvedItems }}</div>
              <div class="text-xs text-secondary-500">Approved</div>
            </div>
            <div class="text-center">
              <div class="text-lg font-semibold text-danger-600">{{ review.revokedItems }}</div>
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
              <span [class]="getRiskScoreClass(review.riskScore)" class="font-medium">
                {{ review.riskScore }}
              </span>
          ...
          <div class="flex items-center justify-between text-sm">
            ...
            <span [class]="getDueDateClass(review)">
              {{ review.status === 'completed' ? (review.completionDate | date:'MMM d, y') : (review.endDate | date:'MMM d, y') }}
            </span>
          </div>

          <!-- Findings Alert -->
          <div *ngIf="review.findings.length > 0" class="mt-3 p-2 bg-warning-50 border border-warning-200 rounded-md">
            <div class="flex items-center space-x-2">
              <svg class="w-4 h-4 text-warning-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              <span class="text-sm text-warning-800">{{ review.findings.length }} finding(s) require attention</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div *ngIf="filteredReviews().length === 0" class="text-center py-12">
        ...
        <h3 class="mt-2 text-sm font-medium text-secondary-900">No access reviews found</h3>
        <p class="mt-1 text-sm text-secondary-500">Get started by creating your first access review campaign.</p>
        <div class="mt-6">
      ...
      >
        ...
        >
          <div class="px-6 py-4 border-b border-secondary-200">
            <div class="flex items-center justify-between">
              <div>
                <h3 class="text-lg font-medium text-secondary-900">{{ selectedReview()!.name }}</h3>
                <p class="text-sm text-secondary-600 mt-1">{{ selectedReview()!.description }}</p>
              </div>
              <button 
                (click)="closeReviewDetails()"
          ...
          <div class="px-6 py-4 max-h-[70vh] overflow-y-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <div class="lg:col-span-1 space-y-4">
                <div>
                  ...
                  <span class="mt-1" [class]="getStatusBadgeClass(selectedReview()!.status)">
                    {{ getStatusLabel(selectedReview()!.status) }}
                  </span>
                </div>
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Review Type</label>
                  <p class="mt-1 text-sm text-secondary-900">{{ getReviewTypeLabel(selectedReview()!.reviewType) }}</p>
                </div>
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Frequency</label>
                  <p class="mt-1 text-sm text-secondary-900">{{ selectedReview()!.frequency }}</p>
                </div>
                <div>
                ...
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Progress</label>
                  <div class="mt-1">
                    <div class="flex items-center justify-between text-sm mb-1">
                      <span>{{ selectedReview()!.completedItems }}/{{ selectedReview()!.totalItems }}</span>
              ...
              <div class="lg:col-span-2">
                <h4 class="text-lg font-medium text-secondary-900 mb-4">Review Statistics</h4>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div class="text-center p-3 bg-secondary-50 rounded-lg">
                    <div class="text-2xl font-bold text-secondary-900">{{ selectedReview()!.totalItems }}</div>
                    <div class="text-sm text-secondary-600">Total Items</div>
                  </div>
                  <div class="text-center p-3 bg-success-50 rounded-lg">
                    <div class="text-2xl font-bold text-success-600">{{ selectedReview()!.approvedItems }}</div>
                    <div class="text-sm text-secondary-600">Approved</div>
                  </div>
                  <div class="text-center p-3 bg-danger-50 rounded-lg">
                    <div class="text-2xl font-bold text-danger-600">{{ selectedReview()!.revokedItems }}</div>
                    <div class="text-sm text-secondary-600">Revoked</div>
                  </div>
                  <div class="text-center p-3 bg-warning-50 rounded-lg">
                    <div class="text-2xl font-bold text-warning-600">{{ selectedReview()!.flaggedItems }}</div>
                ...
                <div class="mt-6">
                  <div class="flex items-center justify-between mb-2">
                    ...
                    <span [class]="getRiskScoreClass(selectedReview()!.riskScore)" class="text-lg font-bold">
            ...
            <!-- Review Scope -->
            <div class="mb-6">
              <h4 class="text-lg font-medium text-secondary-900 mb-4">Review Scope</h4>
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Departments</label>
                ...
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Systems</label>
                  <div class="mt-1 flex flex-wrap gap-1">
                    <span 
                ...
                <div>
                  <label class="block text-sm font-medium text-secondary-700">Access Types</label>
                  <div class="mt-1 flex flex-wrap gap-1">
                    <span 
            ...
            <div *ngIf="selectedReview()!.findings.length > 0" class="mb-6">
              <h4 class="text-lg font-medium text-secondary-900 mb-4">Review Findings</h4>
              <div class="space-y-3">
                <div *ngFor="let finding of selectedReview()!.findings" class="border border-secondary-200 rounded-lg p-4">
                  <div class="flex items-start justify-between mb-2">
                    <div class="flex-1">
                      <h5 class="font-medium text-secondary-900">{{ getFindingTypeLabel(finding.type) }}</h5>
                  ...
                  <div class="text-sm text-secondary-600 mb-2">
                    <span class="font-medium">Risk Impact:</span> {{ finding.riskImpact }}
                  </div>
            ...
            <!-- Reviewers -->
            <div class="mb-6">
              <h4 class="text-lg font-medium text-secondary-900 mb-4">Reviewers</h4>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div *ngFor="let reviewer of selectedReview()!.metadata.reviewers" class="border border-secondary-200 rounded-lg p-3">
                  <div class="flex items-center justify-between mb-2">
                    <h5 class="font-medium text-secondary-900">{{ reviewer.name }}</h5>
                    <span class="text-sm text-secondary-500">{{ reviewer.role }}</span>
                  </div>
                  <div class="text-sm text-secondary-600 mb-2">
                    Progress: {{ reviewer.completedItems }}/{{ reviewer.assignedItems }} items
                  </div>
                  ...
                  <div class="text-xs text-secondary-500">
                    Last activity: {{ reviewer.lastActivity | date:'MMM d, h:mm a' }}
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        ...
        >
          <div class="px-6 py-4 border-b border-secondary-200">
            <h3 class="text-lg font-medium text-secondary-900">Create Access Review</h3>
          </div>
          
          <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="md:col-span-2">
                <label class="block text-sm font-medium text-secondary-700 mb-2">Review Name</label>
                <input
                  type="text"
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Review Type</label>
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-2">Frequency</label>
                <select class="block w-full border border-secondary-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500">
          ...
          <div class="px-6 py-4 border-t border-secondary-200 flex justify-end space-x-3">
            ...
            <button (click)="createReview()" class="btn-primary">Create Review</button>
          </div>
        </div>
      </div>
    </div>
...
export class AccessReviewsComponent implements OnInit {
  ...
  filteredReviews = computed(() => {
    ...
    if (f.searchQuery) {
      ...
      filtered = filtered.filter(review =>
        ...
        review.reviewedBy.some(reviewer => reviewer.toLowerCase().includes(query))
      );
    }
    ...
    if (f.reviewType) {
      filtered = filtered.filter(review => review.reviewType === f.reviewType);
    }

    if (f.dateFrom) {
      filtered = filtered.filter(review => review.startDate >= new Date(f.dateFrom));
    }

    if (f.dateTo) {
      filtered = filtered.filter(review => review.endDate <= new Date(f.dateTo));
    }
  ...
  getTotalPendingItems(): number {
    return this.reviews().reduce((sum, review) => sum + (review.totalItems - review.completedItems), 0);
  }

  getTotalCompletedItems(): number {
    return this.reviews().reduce((sum, review) => sum + review.completedItems, 0);
  }
  ...
  getStatusBadgeClass(status: ReviewStatus): string {
    ...
    switch (status) {
      case ReviewStatus.Planned: return `${baseClass} bg-secondary-100 text-secondary-800`;
      case ReviewStatus.InProgress: return `${baseClass} bg-blue-100 text-blue-800`;
      case ReviewStatus.Review: return `${baseClass} bg-warning-100 text-warning-800`;
      case ReviewStatus.Completed: return `${baseClass} bg-success-100 text-success-800`;
      case ReviewStatus.Cancelled: return `${baseClass} bg-secondary-100 text-secondary-800`;
      case ReviewStatus.Overdue: return `${baseClass} bg-danger-100 text-danger-800`;
  ...
  getReviewTypeIconClass(reviewType: ReviewType): string {
    ...
    switch (reviewType) {
      case ReviewType.AccessCertification: return `${baseClass} bg-primary-100 text-primary-600`;
      case ReviewType.RoleCertification: return `${baseClass} bg-green-100 text-green-600`;
      case ReviewType.PermissionReview: return `${baseClass} bg-blue-100 text-blue-600`;
      case ReviewType.OrphanedAccountReview: return `${baseClass} bg-orange-100 text-orange-600`;
      case ReviewType.PrivilegedAccessReview: return `${baseClass} bg-purple-100 text-purple-600`;
      case ReviewType.ComplianceReview: return `${baseClass} bg-indigo-100 text-indigo-600`;
  ...
  getReviewTypeLabel(reviewType: ReviewType): string {
    switch (reviewType) {
      case ReviewType.AccessCertification: return 'Access Certification';
      case ReviewType.RoleCertification: return 'Role Certification';
      case ReviewType.PermissionReview: return 'Permission Review';
      case ReviewType.OrphanedAccountReview: return 'Orphaned Account Review';
      case ReviewType.PrivilegedAccessReview: return 'Privileged Access Review';
      case ReviewType.ComplianceReview: return 'Compliance Review';
  ...
  getDueDateClass(review: AccessReview): string {
    ...
    const daysDiff = Math.ceil((review.endDate.getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24));
  ...
  getFindingTypeLabel(type: FindingType): string {
    switch (type) {
      case FindingType.ExcessiveAccess: return 'Excessive Access';
      case FindingType.OrphanedAccount: return 'Orphaned Account';
      case FindingType.InactiveUser: return 'Inactive User';
      case FindingType.PolicyViolation: return 'Policy Violation';
      case FindingType.RiskFlag: return 'Risk Flag';
      case FindingType.ComplianceGap: return 'Compliance Gap';
      default: return type;
    }
  }
