    ...
    <div class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-secondary-600 mt-1">
            Monitor compliance status, audit activities, and risk indicators
          </p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-secondary-600"
                >{{ getControlsPassRate() }}% pass rate</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="metric-card">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-secondary-600"
                >{{ metrics().remediationProgress?.overdue || 0 }} overdue</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="font-medium text-secondary-900">{{
                metrics().riskDistribution?.medium || 0
              }}</span>
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <div
              *ngFor="let log of recentLogs().slice(0, 5)"
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm text-secondary-900 truncate">
                  {{ log.action }}
                </p>
                <p class="text-xs text-secondary-500">
                  {{ log.userName }} • {{ log.timestamp | date: "short" }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <div
              *ngFor="let review of activeReviews().slice(0, 3)"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <div
              *ngFor="let violation of openViolations().slice(0, 4)"
              class="border border-secondary-200 rounded-lg p-3"
            >
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <div
              *ngFor="let finding of openFindings().slice(0, 4)"
              class="border border-secondary-200 rounded-lg p-3"
            >
              <div class="flex items-start justify-between mb-2">
                <p class="text-sm font-medium text-secondary-900">
