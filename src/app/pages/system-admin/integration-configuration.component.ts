        ...
        <ol class="flex items-center space-x-4">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a
                routerLink="/admin"
                class="ml-4 text-sm font-medium text-secondary-500 hover:text-secondary-700"
                >System Admin</a
              >
            </div>
          </li>
          ...
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-4 text-sm font-medium text-secondary-900"
                >{{
                  integration()?.displayName || "New Integration"
                }}
                Configuration</span
              >
            </div>
      ...
      <div class="flex justify-between items-start">
        <div>
          ...
          <p class="text-secondary-600 mt-1">
            {{
              isNewIntegration()
                ? "Set up a new system integration"
                : "Modify integration settings and connections"
            }}
          </p>
          <div
            *ngIf="!isNewIntegration() && integration()"
            class="flex items-center space-x-3 mt-3"
          >
            <span
            ...
            <span class="text-sm text-secondary-500"
              >{{ integration()!.vendor }} • v{{ integration()!.version }}</span
            >
          </div>
        </div>
        ...
        <div class="px-6 py-4">
          ...
          <div class="mt-4 flex flex-wrap gap-2">
            ...
            >
              ...
              <span
                *ngIf="section.required && !section.completed"
      ...
      <form [formGroup]="configForm" class="space-y-6">
        ...
        <div *ngIf="activeSection() === 'basic'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Configure the fundamental integration settings
            </p>
          </div>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div>
                ...
                <div
                  *ngIf="
                    configForm.get('displayName')?.invalid &&
                    configForm.get('displayName')?.touched
                  "
              ...
              <div>
                ...
                <p class="mt-1 text-xs text-secondary-500">
                  Unique system identifier (alphanumeric and hyphens only)
                </p>
              </div>
              ...
              <div>
                <label class="flex items-center">
                  ...
                  <span class="ml-2 text-sm text-secondary-700"
                    >Enable integration after configuration</span
                  >
                </label>
              </div>
            </div>
        ...
        <div *ngIf="activeSection() === 'connection'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Configure the connection settings and endpoints
            </p>
          </div>
          <div formGroupName="configuration" class="space-y-6">
            ...
            <div>
              ...
              <div formArrayName="customSettings" class="space-y-3">
                <div
                  *ngFor="
                    let setting of customSettingsArray.controls;
                    let i = index
                  "
                  [formGroupName]="i"
        ...
        <div *ngIf="activeSection() === 'authentication'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Configure authentication methods and credentials
            </p>
          </div>
...
MIIEvQIBADANBgkqhkiG9w0BAQE..."
        ...
        <div *ngIf="activeSection() === 'mapping'" class="card">
          <div class="card-header">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="card-subtitle">
                  Map external system fields to internal data structure
                </p>
              </div>
              <button
                type="button"
          ...
          <div formArrayName="dataMappings" class="space-y-4">
            <div
              *ngFor="let mapping of dataMappingsArray.controls; let i = index"
              [formGroupName]="i"
            ...
            <div
              *ngIf="dataMappingsArray.length === 0"
              class="text-center py-8 text-secondary-500"
            >
              No data mappings configured. Click "Add Mapping" to create field
              mappings.
            </div>
          </div>
        </div>
        ...
        <div *ngIf="activeSection() === 'health'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Configure health monitoring and availability checks
            </p>
          </div>
            ...
            <div>
              <label class="flex items-center">
                ...
                <span class="ml-2 text-sm font-medium text-secondary-700"
                  >Enable health checks</span
                >
              </label>
            </div>

            <div
              *ngIf="configForm.get('healthCheck.enabled')?.value"
              class="space-y-4"
            >
              ...
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-3"
                  >Health Check Types</label
                >
                <div formArrayName="checks" class="space-y-3">
                  <div
                    *ngFor="
                      let check of healthChecksArray.controls;
                      let i = index
                    "
                    [formGroupName]="i"
        ...
        <div *ngIf="activeSection() === 'monitoring'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Configure monitoring, logging, and alert thresholds
            </p>
          </div>
          <div formGroupName="monitoring" class="space-y-6">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm font-medium text-secondary-700"
                      >Collect performance metrics</span
                    >
                  </label>
                </div>
                ...
                <div formGroupName="alerting">
                  <div>
                    <label class="flex items-center">
                      ...
                      />
                      <span class="ml-2 text-sm font-medium text-secondary-700"
                        >Enable alerting</span
                      >
                    </label>
                  </div>

                  <div
                    *ngIf="configForm.get('monitoring.alerting.enabled')?.value"
                  >
                    <label
                      class="block text-sm font-medium text-secondary-700 mb-2 mt-4"
                      >Alert Channels</label
                    >
                    <div formArrayName="channels" class="space-y-2">
                      <div
                        *ngFor="
                          let channel of alertChannelsArray.controls;
                          let i = index
                        "
                        class="flex items-center space-x-3"
                      >
            ...
            >
              ...
              <div formArrayName="thresholds" class="space-y-3">
                <div
                  *ngFor="
                    let threshold of alertThresholdsArray.controls;
                    let i = index
                  "
                  [formGroupName]="i"
      ...
      >
        ...
        >
            ...
            <div class="space-y-4">
              <div class="flex items-center space-x-3">
                <div
                  [class]="
                    testResults()?.success
                      ? 'w-8 h-8 bg-success-100 rounded-full flex items-center justify-center'
                      : 'w-8 h-8 bg-danger-100 rounded-full flex items-center justify-center'
                  "
                >
                  <svg
                    *ngIf="testResults()?.success"
              ...
              <div
                *ngIf="testResults()?.details"
                class="bg-secondary-50 rounded-lg p-4"
              >
                <h5 class="text-sm font-medium text-secondary-900 mb-2">
                  Test Details
                </h5>
                <pre class="text-sm text-secondary-700 whitespace-pre-wrap">{{
                  testResults()?.details
                }}</pre>
              </div>
            </div>
          ...
          <div class="px-6 py-4 border-t border-secondary-200 flex justify-end">
            <button (click)="closeTestResults()" class="btn-primary">
              Close
            </button>
          </div>
        </div>
...
export class IntegrationConfigurationComponent implements OnInit {
  ...
  isNewIntegration = computed(
    () => !this.integrationId() || this.integrationId() === "new",
  );
  ...
  private updateSectionCompletion(): void {
    ...
    sections.forEach((section) => {
      switch (section.id) {
        ...
        case "connection":
          section.completed = !!(
            form.get("configuration.protocol")?.value &&
  ...
  isConfigurationValid(): boolean {
    const requiredSections = this.configurationSections().filter(
      (s) => s.required,
    );
  ...
  addAlertThreshold(): void {
    this.alertThresholdsArray.push(
      this.fb.group({
        metric: [""],
        operator: [">"],
        value: [""],
