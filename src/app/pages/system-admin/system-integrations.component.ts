          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-success-600"
                >{{ getActiveIntegrationsCount() }} active</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="metric-card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-semibold text-success-600 mt-2">
                {{ getHealthyIntegrationsCount() }}
              </p>
            </div>
            <div
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span class="text-secondary-600"
                >{{ getHealthPercentage() }}% uptime</span
              >
            </div>
          </div>
        </div>
            ...
            <div class="flex items-start space-x-4 flex-1">
              ...
              <div class="flex-1">
                <div class="flex items-center space-x-3 mb-2">
                  ...
                  <span
                    [class]="getIntegrationTypeBadgeClass(integration.type)"
                  >
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div *ngIf="integration.lastHealthCheck">
                    ...
                    <span
                      class="ml-1"
                      [class]="getHealthCheckClass(integration.lastHealthCheck)"
                    >
                ...
                <div *ngIf="integration.dataMappings.length > 0" class="mt-3">
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-sm text-secondary-600"
                      >{{ integration.dataMappings.length }} field mappings
                      configured</span
                    >
                  </div>
                </div>
                ...
                <div class="mt-3 flex items-center space-x-4 text-sm">
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-secondary-600">{{
                      getConnectionEndpoint(integration)
                    }}</span>
                  </div>
                  <div class="flex items-center space-x-2">
                    <span class="text-secondary-500">Auth:</span>
                    <span class="text-secondary-900">{{
                      getAuthTypeLabel(integration.authentication.type)
                    }}</span>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        >
          ...
          <div class="px-6 py-4 max-h-[70vh] overflow-y-auto">
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      <p class="mt-1 text-sm text-secondary-900">
                        {{
                          getIntegrationTypeLabel(selectedIntegration()!.type)
                        }}
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span
                        class="mt-1"
                        [class]="
                          getIntegrationStatusBadgeClass(
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      <p class="mt-1 text-sm text-secondary-900 font-mono">
                        {{ getConnectionEndpoint(selectedIntegration()!) }}
                      </p>
                    </div>
                    <div>
                      <label
                      ...
                      >
                      <p class="mt-1 text-sm text-secondary-900">
                        {{ selectedIntegration()!.configuration.protocol }}
                      </p>
                    </div>
                    <div>
                      <label
                      ...
                      <p class="mt-1 text-sm text-secondary-900">
                        {{
                          getAuthTypeLabel(
                            selectedIntegration()!.authentication.type
                          )
                        }}
                      </p>
                    </div>
            ...
            <div *ngIf="detailsTab() === 'configuration'" class="space-y-6">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-4">
                  <div>
                    ...
                    >
                    <p class="mt-1 text-sm text-secondary-900">
                      {{ selectedIntegration()!.configuration.timeout }}
                    </p>
                  </div>
                  <div>
                    <label class="block text-sm font-medium text-secondary-700"
                    ...
                    >
                    <p class="mt-1 text-sm text-secondary-900">
                      {{ selectedIntegration()!.configuration.retryAttempts }}
                    </p>
                  </div>
                  <div *ngIf="selectedIntegration()!.configuration.batchSize">
                    ...
                    >
                    <p class="mt-1 text-sm text-secondary-900">
                      {{ selectedIntegration()!.configuration.batchSize }}
                    </p>
                  </div>
                </div>
                <div class="space-y-4">
                  <div
                    *ngIf="selectedIntegration()!.configuration.syncInterval"
                  >
                    <label class="block text-sm font-medium text-secondary-700"
                      >Sync Interval (seconds)</label
                    >
                    <p class="mt-1 text-sm text-secondary-900">
                      {{ selectedIntegration()!.configuration.syncInterval }}
                    </p>
                  </div>
                  <div *ngIf="selectedIntegration()!.configuration.port">
                    ...
                    >
                    <p class="mt-1 text-sm text-secondary-900">
                      {{ selectedIntegration()!.configuration.port }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div *ngIf="hasCustomSettings(selectedIntegration()!)">
                <h5 class="text-md font-medium text-secondary-900 mb-3">
                  Custom Settings
                </h5>
                <div class="bg-secondary-50 rounded-lg p-4">
                  <pre class="text-sm text-secondary-900 whitespace-pre-wrap">{{
                    formatCustomSettings(
                      selectedIntegration()!.configuration.customSettings
                    )
                  }}</pre>
                </div>
              </div>
            ...
            <div *ngIf="detailsTab() === 'mappings'" class="space-y-6">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-secondary-600"
                  >{{ selectedIntegration()!.dataMappings.length }} mappings
                  configured</span
                >
              </div>
              <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-secondary-200">
                  ...
                  <tbody class="bg-white divide-y divide-secondary-200">
                    <tr
                      *ngFor="
                        let mapping of selectedIntegration()!.dataMappings
                      "
                    >
                      <td
                        class="px-6 py-4 whitespace-nowrap text-sm font-mono text-secondary-900"
                      >
                        {{ mapping.sourceField }}
                      </td>
                      <td
            ...
            <div *ngIf="detailsTab() === 'monitoring'" class="space-y-6">
              ...
              <div class="border border-secondary-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-4">
                  <h5 class="text-md font-medium text-secondary-900">
                    Health Check Settings
                  </h5>
                  <span
                    [class]="
                      selectedIntegration()!.healthCheck.enabled
                        ? 'text-success-600'
                        : 'text-secondary-500'
                    "
                    class="text-sm"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <span class="ml-1 text-secondary-900"
                      >{{ selectedIntegration()!.healthCheck.interval }}s</span
                    >
                  </div>
                  <div>
                    <span class="text-secondary-500">Timeout:</span>
                    <span class="ml-1 text-secondary-900"
                      >{{ selectedIntegration()!.healthCheck.timeout }}s</span
                    >
                  </div>
                  <div>
                    <span class="text-secondary-500">Checks:</span>
                    <span class="ml-1 text-secondary-900">{{
                      selectedIntegration()!.healthCheck.checks.length
                    }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="border border-secondary-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-4">
                  ...
                  <span
                    [class]="
                      selectedIntegration()!.monitoring.enabled
                        ? 'text-success-600'
                        : 'text-secondary-500'
                    "
                    class="text-sm"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <span class="ml-1 text-secondary-900">{{
                      selectedIntegration()!.monitoring.metricsCollection
                        ? "Enabled"
                        : "Disabled"
                    }}</span>
                  </div>
                  <div>
                    ...
                    <span class="ml-1 text-secondary-900">{{
                      selectedIntegration()!.monitoring.logLevel
                    }}</span>
                  </div>
                  <div>
                    <span class="text-secondary-500">Alerting:</span>
                    <span class="ml-1 text-secondary-900">{{
                      selectedIntegration()!.monitoring.alerting.enabled
                        ? "Enabled"
                        : "Disabled"
                    }}</span>
                  </div>
              ...
              <div
                *ngIf="
                  selectedIntegration()!.monitoring.alerting.thresholds.length >
                  0
                "
              >
                <h5 class="text-md font-medium text-secondary-900 mb-3">
                ...
                <div class="space-y-2">
                  <div
                    *ngFor="
                      let threshold of selectedIntegration()!.monitoring
                        .alerting.thresholds
                    "
                  ...
                  >
                    <div class="flex items-center space-x-4">
                      ...
                      <span class="text-secondary-600"
                        >{{ threshold.operator }} {{ threshold.value }}</span
                      >
                    </div>
          ...
          >
            ...
            <button (click)="closeIntegrationDetails()" class="btn-primary">
              Close
            </button>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <button (click)="createIntegration()" class="btn-primary">
              Create Integration
            </button>
          </div>
        </div>
...
export class SystemIntegrationsComponent implements OnInit {
  ...
  filteredIntegrations = computed(() => {
    ...
    if (f.category) {
      filtered = filtered.filter(
        (integration) => integration.category === f.category,
      );
    }

    if (f.status) {
      filtered = filtered.filter(
        (integration) => integration.status === f.status,
      );
    }
  ...
  testConnection(integration: SystemIntegration): void {
    ...
    this.adminService
      .testIntegrationConnection(integration.id)
      .subscribe((result) => {
  ...
  syncIntegration(integration: SystemIntegration): void {
    ...
    this.adminService
      .syncIntegrationData(integration.id)
      .subscribe((result) => {
  ...
  syncAllIntegrations(): void {
    const activeIntegrations = this.integrations().filter(
  ...
  getIntegrationIconClass(type: IntegrationType): string {
    ...
    switch (type) {
      case IntegrationType.Identity:
        return `${baseClass} bg-blue-100 text-blue-600`;
      case IntegrationType.Directory:
  ...
  getIntegrationCategoryLabel(category: IntegrationCategory): string {
    switch (category) {
      case IntegrationCategory.Authentication:
        return "Authentication";
      case IntegrationCategory.UserProvisioning:
        return "User Provisioning";
      case IntegrationCategory.DataSync:
        return "Data Sync";
      case IntegrationCategory.Monitoring:
        return "Monitoring";
      case IntegrationCategory.Reporting:
        return "Reporting";
      case IntegrationCategory.Workflow:
        return "Workflow";
      default:
        return category;
    }
  ...
  getConnectionEndpoint(integration: SystemIntegration): string {
    return (
      ...
      integration.configuration.connectionString ||
      "Not configured"
    );
  }
  ...
  hasCustomSettings(integration: SystemIntegration): boolean {
    return (
      integration.configuration.customSettings &&
