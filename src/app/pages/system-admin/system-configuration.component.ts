      ...
      <div class="flex justify-between items-start">
        <div>
          ...
          <p class="text-secondary-600 mt-1">
            Manage global system settings, security, and operational parameters
          </p>
        </div>
        ...
        <div class="px-6 py-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            >
              ...
              <div
                *ngIf="section.hasChanges"
                class="w-2 h-2 bg-warning-500 rounded-full mt-1"
              ></div>
            </button>
          </div>
        </div>
      ...
      <form [formGroup]="configForm" class="space-y-6">
        ...
        <div *ngIf="activeSection() === 'general'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Basic system configuration and operational parameters
            </p>
          </div>
          <div
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-3">
                ...
                <label class="flex items-center">
                  ...
                  />
                  <span class="ml-2 text-sm text-secondary-700"
                    >Enable analytics collection</span
                  >
                </label>
              </div>
            </div>
        ...
        <div *ngIf="activeSection() === 'security'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Security policies, encryption, and access control settings
            </p>
          </div>
          <div formGroupName="security" class="space-y-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div class="space-y-4">
                <h4 class="text-md font-medium text-secondary-900">
                  Password Policy
                </h4>
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Idle Session Timeout (minutes)</label
                  >
                  <input
                    type="number"
                ...
                <div class="space-y-2">
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Require multi-factor authentication</span
                    >
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable comprehensive audit logging</span
                    >
                  </label>
                </div>
              </div>
            ...
            <div class="border-t border-secondary-200 pt-6">
              <h4 class="text-md font-medium text-secondary-900 mb-4">
                Encryption Settings
              </h4>
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Key Rotation Interval (days)</label
                  >
                  <input
                    type="number"
        ...
        <div *ngIf="activeSection() === 'authentication'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              SSO, identity providers, and authentication methods
            </p>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Default Authentication Method</label
                  >
                  <select
                ...
                <div class="space-y-2">
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable Single Sign-On (SSO)</span
                    >
                  </label>
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable TOTP (Google Authenticator)</span
                    >
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable email authentication</span
                    >
                  </label>
                ...
                <div>
                  ...
                  />
                  <p class="mt-1 text-xs text-secondary-500">
                    Time before MFA is required again
                  </p>
                </div>
              </div>
            </div>
        ...
        <div *ngIf="activeSection() === 'notifications'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              SMTP configuration and notification preferences
            </p>
          </div>
        ...
        <div *ngIf="activeSection() === 'api'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              REST API settings, rate limiting, and security
            </p>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Requests per minute (per IP)</label
                  >
                  <input
                    type="number"
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Requests per hour (per user)</label
                  >
                  <input
                    type="number"
                ...
                <div class="space-y-2">
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Require API key authentication</span
                    >
                  </label>
                </div>
              </div>
        ...
        <div *ngIf="activeSection() === 'backup'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              Data backup, retention policies, and maintenance schedules
            </p>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Maintenance Duration (hours)</label
                  >
                  <input
                    type="number"
                ...
                <div class="space-y-2">
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable maintenance mode during windows</span
                    >
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Notify users before maintenance</span
                    >
                  </label>
                </div>
              </div>
        ...
        <div *ngIf="activeSection() === 'logging'" class="card">
          <div class="card-header">
            ...
            <p class="card-subtitle">
              System logs, performance monitoring, and alerting
            </p>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable remote logging (syslog)</span
                    >
                  </label>
                </div>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-secondary-700 mb-2"
                    >Metrics Collection Interval (seconds)</label
                  >
                  <input
                    type="number"
                ...
                <div class="space-y-2">
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-2 text-sm text-secondary-700"
                      >Enable performance monitoring</span
                    >
                  </label>
      ...
      >
        ...
        >
              ...
              <div class="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-secondary-600">
                    Testing system configuration settings...
                  </p>
                </div>
              </div>
          ...
          <div class="px-6 py-4 border-t border-secondary-200 flex justify-end">
            <button (click)="closeTestModal()" class="btn-primary">
              Close
            </button>
          </div>
        </div>
...
export class SystemConfigurationComponent implements OnInit {
  ...
  private initializeForm(): void {
    this.configForm = this.fb.group({
      general: this.fb.group({
        ...
        systemDescription: [
          "Enterprise Lifecycle and Access Management System",
        ],
        ...
        reader.onload = (e: any) => {
          try {
            ...
            this.showNotification(
              ...
              "Please review and save the imported settings.",
            );
          } catch (error) {
            this.showNotification(
              "error",
  ...
  getSectionButtonClass(section: ConfigurationSection): string {
    const baseClass =
      "flex flex-col items-center p-4 rounded-lg text-sm font-medium transition-colors";
