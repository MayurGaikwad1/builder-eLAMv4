...
@Component({
  ...
  template: `
    <aside class="bg-white shadow-sm border-r border-secondary-200 h-full w-64 flex flex-col">
      <!-- Logo and Title -->
        ...
        <ng-container *ngFor="let item of navItems">
          <div>
            <a
              ...
              [class]="rla.isActive ? 'sidebar-link sidebar-link-active' : 'sidebar-link sidebar-link-inactive'"
            >
            ...
            <!-- Sub-navigation -->
            <div *ngIf="item.children && rla.isActive" class="ml-8 mt-1 space-y-1">
              <a
      ...
      <div class="px-4 py-4 border-t border-secondary-200">
        <div class="flex items-center space-x-3">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm font-medium text-secondary-900 truncate">John Doe</p>
